...
- **M1 Product and Device Sync** — Device identity, product model, contracts, and initial reference-data sync.
- **M2 Offline Sale** — Fully local transaction workflow for sales and payments.
- **M3 Cloud Synchronization** — Idempotent outbox processing, retries, conflict rules, and observability.
- **M4 Shift and Cash Management** — Local shifts, cash movements, reconciliation, and cloud consolidation.
