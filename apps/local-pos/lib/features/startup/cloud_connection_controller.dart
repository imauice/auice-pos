...
final cloudConnectionProvider =
    StateNotifierProvider<CloudConnectionController, CloudConnectionState>(
      (ref) => CloudConnectionController(ref.read(cloudHealthClientProvider)),
    );

class CloudConnectionController extends StateNotifier<CloudConnectionState> {
  CloudConnectionController(this._client)
    : super(const CloudConnectionState(CloudConnectionStatus.notChecked));
