...
import { ArrayMaxSize, ArrayNotEmpty, IsArray, IsIn, IsInt, IsObject, IsString, IsUUID, Matches, Min, ValidateNested } from 'class-validator';
...
export class SyncEventDto {
  ...
  @ApiProperty({ enum: SYNC_ENTITY_TYPES }) @IsString() entityType!: string;
